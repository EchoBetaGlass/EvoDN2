...
Setslog = {};
Setslog(1) = {'Setslog5-2_num1.mat'};
Setslog(2) = {'Setslog5-3_num1.mat'};
%%
% 
%   for x = 1:10
%       disp(x)
...
Predator_popsize = 50;     %Number of Predators 100

no_generations = 20;       %max generations
...
%2D-lattice
no_x = 50;                  %lattice size (no of rows) 50
no_y = 50;                  %lattice size (no of cols) 50
KillInterval = 4;          %Interval at which bad preys are eliminated
maxrank = 20;               %maxrank retained at KillInterval
...
global obj
% 
penalty = 0;               % Penalty to be set by user
LB_F = [200 2];
UB_F = [1000 60];
